...
public class filterChannelAdapter extends RecyclerView.Adapter<filterChannelAdapter.ListViewHolder> {
    ...
    public filterChannelAdapter(List<NewsPost> newsPostList, Context context, String listType,List<GetFav> getFavList) {
            ...
            if(getFavList!=null){
                for(int i=0;i<getFavList.size();i++){
                    ...
                    if(newsPostList.get(position).getTitle().equals(getFavList.get(i).getPostTitle())){
                        Log.d("news", "onBindViewHolder: "+newsPostList);
                        holder.favourite.setImageResource(R.drawable.favtrue);
                    }
                }
            }
            Log.d("news", "onBindViewHolder: "+newsPostList.get(position));
    ...
    public void addAndDel(ListViewHolder holder, int position){
